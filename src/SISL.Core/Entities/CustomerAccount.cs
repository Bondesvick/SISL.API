...
namespace SISL.Core.Entities
{
    public class CustomerAccount : BaseEntity
    {
        ...
        {
            SislHistories = new List<SislHistory>();
            SislDocuments = new List<SislDocument>();
        }
        ...
        public DateTime? MeansOfIDIssueDate { get; set; } = null;
        ...
        public ICollection<SislHistory> SislHistories { get; set; }
        public ICollection<SislDocument> SislDocuments { get; set; }

        //public SislStatus SislStatus { get; set; }
        //public long SislStatusId { get; set; }
    }
}